<script>
	...
	const signUp = () => {
		Fetch.Post('/api/users', user).then(() => {
			goto('/auth/sign-in')
		})
	}
</script>
			...
			<div class="d-flex flex-column h-100">
				...
				<div class="my-auto">
					<div>
						...
						<p class="text-muted">Regístrate para disfrutar del sistema.</p>
					</div>
					...
					<div class="mt-4">
						...
						<div class="mt-5 text-center">
							<p>
								¿Ya tienes cuenta? <a href="/auth/sign-in" class="fw-medium text-primary">
									Inicia Sesión
								</a>
							</p>
						</div>
