...
!(function (t, e) {
			...
			j('inspectSource', function (t) {
				...
				(t.exports = function (t, e, n, s) {
					...
					'function' == typeof n &&
						...
						t !== E
							? (o ? !l && t[e] && (a = !0) : delete t[e], a ? (t[e] = n) : T(t, e, n))
							: a
							? (t[e] = n)
							: R(e, n)
		...
		return [
			...
			function (t, n) {
				...
				for (var v, g = '', b = 0, m = 0; m < d.length; m++) {
					p = d[m]
					for (
						var y = String(p[0]), x = de(pe(u(p.index), a.length), 0), E = [], w = 1;
						w < p.length;
						w++
					)
	...
	function ki(t, e) {
		var i,
			...
			n = t.__data__
		return (
			'string' == (r = typeof (i = e)) || 'number' == r || 'symbol' == r || 'boolean' == r
				? '__proto__' !== i
				: null === i
		)
	...
	var Qi = (function () {
		...
		tr = (function () {
			function t(t, e, i) {
				if (
					((this.activeObservations_ = []), (this.observations_ = new Ci()), 'function' != typeof t)
				)
			...
			return (
				(t.prototype.observe = function (t) {
					...
					if ('undefined' != typeof Element && Element instanceof Object) {
						...
						e.has(t) ||
							(e.set(t, new Qi(t)), this.controller_.addObserver(this), this.controller_.refresh())
					}
				}),
			...
			;(this.onScroll = function () {
				...
				(this.onPointerEvent = function (t) {
					...
					;(r.axis.x.scrollbar.rect = r.axis.x.scrollbar.el.getBoundingClientRect()),
						...
						(e || i) &&
							(t.preventDefault(),
							t.stopPropagation(),
							'mousedown' === t.type && (e && r.onDragStart(t, 'y'), i && r.onDragStart(t, 'x')))
				}),
				(this.drag = function (e) {
					...
					var l =
						...
						(o - a)
					'x' === r.draggedAxis &&
						((l = r.isRtl && t.getRtlHelpers().isRtlScrollbarInverted ? l - (n + s.size) : l),
		...
		return (
			(e.init = function () {
				;(this.el.SimpleBar = this),
					nr &&
						(this.initDOM(), (this.scrollbarWidth = sr()), this.recalculate(), this.initListeners())
			}),
			(e.initDOM = function () {
				var t = this
				if (
			...
			(e.positionScrollbar = function (e) {
				...
				var i = this.contentWrapperEl[this.axis[e].scrollSizeAttr],
					...
					a =
						(o = 'x' === e && this.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -o : o) /
						(i - n),
					l = ~~((r - s.size) * a)
				;(l =
